...
namespace SimpleScript.Parser.Tests.Helper.Extensions
{
    ...
    {
        public static TStatement AssertBody<TStatement>(this BodyNode bodyNode)
        {
            bodyNode.ChildNodes.Count.Should().Be(1);
            return TH.ConvertTo<TStatement>(bodyNode.ChildNodes[0]);
        }

        public static (TFirstStatement, TSecondStatement) AssertBody<TFirstStatement, TSecondStatement>(this BodyNode bodyNode)
        {
        ...
        public static (TFirstStatement, TSecondStatement, TThirdStatement) AssertBody<TFirstStatement, TSecondStatement, TThirdStatement>(this BodyNode bodyNode)
        {
